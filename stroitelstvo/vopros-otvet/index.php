		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<span>/</span>			
					<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="#"><span itemprop="name">Вопрос-ответ</span></a><meta itemprop="position" content="3" /></span>
				</div>
			</div>
		</div>
	</section>
...
<p align="center"><img style="border: 1px solid #c0d0e0;padding: 3px;width:600px;"  src="/upload/medialibrary/73d/вопрос-ответ.jpg"></p>
