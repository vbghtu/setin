...
$arSelect = Array("NAME", "PROPERTY_h1", "DETAIL_TEXT", "ID" => 1949);
$arFilter = Array("IBLOCK_ID"=>26, "ID" => 1949);
...
$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(26,1949); 
