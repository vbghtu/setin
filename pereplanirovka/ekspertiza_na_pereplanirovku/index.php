...
$arSelect = Array("NAME", "PROPERTY_h1", "DETAIL_TEXT", "ID" => 1950);
$arFilter = Array("IBLOCK_ID"=>26, "ID" => 1950);
...
$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(26,1950); 
