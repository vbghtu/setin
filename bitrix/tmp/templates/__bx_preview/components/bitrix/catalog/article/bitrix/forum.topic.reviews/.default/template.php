...
?>
	<table cellspacing="0" border="0" class="reviews-post-table <?=($iCount == 1 ? "reviews-post-first " : "")?><?
		...
		<?if ($arParams["SHOW_RATING"] == "Y") { ?>
			<div class="review-rating rating_vote_standart">
				<?
				...
				$GLOBALS["APPLICATION"]->IncludeComponent( "bitrix:rating.vote", "", $arRatingParams, $component, array("HIDE_ICONS" => "Y"));
				?>
			</div>
		<? } ?>
<div>
...
?>
	<div class="reviews-reply-header"><?=$arParams["MESSAGE_TITLE"]?><span class="reviews-required-field">*</span></div>
