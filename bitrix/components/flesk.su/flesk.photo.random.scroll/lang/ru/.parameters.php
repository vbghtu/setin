...
$MESS ['CHARS_TITLE'] = "Максимальное количество символов в названии";
$MESS ['PHOTO_TOTAL'] = "Количетсво фотографий";
$MESS ['BLOCK_HEIGHT'] = "Высота блока, px";
$MESS ['BLOCK_WIDTH'] = "Ширина блока, px";
?>