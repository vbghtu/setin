...
$MESS["MAIN_INCLUDE_AREA_ADD_page"] = "Add include area for the current page";
$MESS["MAIN_INCLUDE_AREA_ADD_sect"] = "Add include area for the current site section";
...
$MESS["MAIN_INCLUDE_AREA_EDIT_page"] = "Edit include area for current page";
$MESS["MAIN_INCLUDE_AREA_EDIT_page_NOEDITOR"] = "Edit page include area as PHP";
$MESS["MAIN_INCLUDE_AREA_EDIT_sect"] = "Edit include area for site section";
