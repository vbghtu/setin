...
$MESS["LANDING_FORM_SETTINGS_DEFAULT_VALUE_MESSAGE_DESCRIPTION"] = "Оберіть потрібні вам поля CRM-сутностей і вкажіть їх значення за допомогою тексту або тегів персоналізації";
$MESS["LANDING_FORM_SETTINGS_DEFAULT_VALUE_MESSAGE_TITLE"] = "Заповнюйте поля автоматично при надсиланні форми";
$MESS["LANDING_FORM_SETTINGS_DEFAULT_VALUE_TITLE"] = "Значення полів за замовчуванням";
