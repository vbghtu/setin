...
$MESS ['SECTION_SORT_FIELD_TIP'] = "Bölümlerin sıralanacağıı alan belirtilmektedir.";
...
$MESS ['FIELD_CODE_TIP'] = "<i>seçim yapılmadı</i> hanesi seçildiğinde ve kod belirtilmediğinde özellik altındaki satırlardaki özellikler gösterilmez.";
$MESS ['PROPERTY_CODE_TIP'] = "Bilgi bloğu özelliklerinden TOP'da görünecekler seçilebilir. <i>seçim yapılmadı</i> seçeneğinin seçilmesinde ve daha alt satırlarda özellik kodunun girilmemesinde TOP'da özellike gösterimi olmaz.";
...
$MESS ['ELEMENT_COUNT_TIP'] = "Her bir bölümde gösterilecek maksimum fotoğrafğraf sayısı";
$MESS ['LINE_ELEMENT_COUNT_TIP'] = "Tablonun bir satırına girilecek fotoğrafğraf sayısı";
?>