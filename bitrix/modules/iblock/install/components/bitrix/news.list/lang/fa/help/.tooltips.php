...
$MESS["FIELD_CODE_TIP"] = "Here you can choose the required inofrmation block element fields by which the filter can be applied. You can add custom fields as a code in the input fields below.";
