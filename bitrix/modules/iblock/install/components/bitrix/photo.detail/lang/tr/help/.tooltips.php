...
$MESS ['IBLOCK_ID_TIP'] = "Seçilen tiplerin bilgi bloklarından birisi seçilir. (??????)-> seçeneği seçildiğinde Bilgi bloğunun kimliğinin yandaki alana girilmesi gerekir. ";
...
$MESS ['ELEMENT_ID_TIP'] = "Alan, Öğe kimliğini belirten kodu içermektedir. Alanda varsayılan olarak ={\$_REQUEST[\"ELEMENT_ID\"]}. öğe kodu belirtilmişse alan boş bırakılabilir..";
$MESS ['SECTION_CODE_TIP'] = "Bölüm kodu belirtilir bölüm kimliği belirtilmişse alan boş bırakılabilir..";
$MESS ['ELEMENT_CODE_TIP'] = "Öğe kodu belirtilir Öğe kimliği belirtilmişse alan boş bırakılabilir..";
$MESS ['ELEMENT_SORT_FIELD_TIP'] = "ileri ve \"geri\" bağlantıları için fotğrafların sıralanacağı alan gösterilir.";
$MESS ['ELEMENT_SORT_ORDER_TIP'] = "Fotoğrafların hangi yönde sıralanacağı gösterilir.";
...
$MESS ['SET_TITLE_TIP'] = "Sayfa başlığı olarak seçeneğin belirtilmesinde, fotoğrafğraf adı tanımlanacaktır.";
