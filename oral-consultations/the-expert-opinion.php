...
$arSelect = Array("NAME", "PROPERTY_h1", "DETAIL_TEXT", "ID" => 1946);
$arFilter = Array("IBLOCK_ID"=>26, "ID" => 1946);
...
$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(26,1946); 
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <span>/</span>
          <span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="/oral-consultations/"><span itemprop="name">Устные консультации</span></a><meta itemprop="position" content="2" /></span>
          <span>/</span>
