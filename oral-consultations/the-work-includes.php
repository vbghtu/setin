...
$arSelect = Array("NAME", "PROPERTY_h1", "DETAIL_TEXT", "ID" => 1947);
$arFilter = Array("IBLOCK_ID"=>26, "ID" => 1947);
...
$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(26,1947); 
