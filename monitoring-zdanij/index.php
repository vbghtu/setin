...
$arSelect = Array("NAME", "PROPERTY_h1", "DETAIL_TEXT", "ID" => 2403);
$arFilter = Array("IBLOCK_ID"=>26, "ID" => 2403);
...
$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(26,2403); 
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<span> / </span>
					<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="#"><span itemprop="name"><?=$row['NAME'];?></span></a><meta itemprop="position" content="2" /></span>
				</div>
			</div>
		</div>
	</section>
