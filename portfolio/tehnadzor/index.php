...
$APPLICATION->SetPageProperty('H1','Технический надзор');

if($numpage>1){
    $APPLICATION->AddChainItem("Страница ".$numpage, "");
    $APPLICATION->SetTitle("Технический надзор – примеры работ компании СтройЭкспертНадзор - Страница ".$numpage);
}else{
    $APPLICATION->SetTitle("Технический надзор – примеры работ компании СтройЭкспертНадзор");
}
...
//!todo  возможно протащить require($_SERVER["DOCUMENT_ROOT"]."/section/section_clients.php
    ...
    <section class="section examples">
        <div class="container">
            <div class="specialization__title title">
                <h2>Технический контроль - Примеры работ<strong>.</strong></h2>
            </div>
