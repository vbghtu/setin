...
require_once($_SERVER["DOCUMENT_ROOT"]. "/bitrix/modules/main/include/prolog_before.php");
	...
	$res = CIBlockElement::GetList(false, Array("IBLOCK_ID" => 1, 'ACTIVE' => 'Y', "SECTION_ID" => array(9)), array('IBLOCK_ID')); 
...
$res = CIBlockElement::GetList ( array("ID" => "DESC"), Array("IBLOCK_ID" => 1, 'ACTIVE' => 'Y', "!PROPERTY_SEVEN"=>false, "SECTION_ID" => array(9)), false, false, $arSelect);
...
if(!empty($mypage)) {
	$APPLICATION->SetPageProperty("title", "Строительная экспертиза – примеры работ компании СтройЭкспертНадзор - страница №" . ($mypage + 1));
	$h1 = '<h1 class="title">Строительная экспертиза - примеры работ - страница №' . ($mypage + 1) . '</h1>';
	$sum_prev = $mypage - 1;
	...
	$APPLICATION->SetPageProperty("title", "Строительная экспертиза – примеры работ компании СтройЭкспертНадзор");
	...
	$prev = "";
	$h1 = '<h1 class="title">Строительная экспертиза - примеры работ</h1>';
	$sum_next = $mypage + 1;
...
<section class="breadcrumbs">
	...
	<section class="sect6">
		...
		<div id="portfolio_usluga" style="display:none;">1</div>
...
list($pagertop, $pagerbottom, $limit) = pager(6, $count_objects, "/portfolio/stroitelnaya-ekspertiza/");
...
$rsElement = CIBlockElement::GetList( array("ID" => "DESC"), Array("IBLOCK_ID" => 1, 'ACTIVE' => 'Y', "SECTION_ID" => array(9)), false,Array("nPageSize"=> 6, "iNumPage" => $numpage), $arSelect );
